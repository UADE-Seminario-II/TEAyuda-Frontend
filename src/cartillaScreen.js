...
export default function Cartilla() {
  ...
  const filterentidad = (value, result) => {
    if (ratingSelected !== "" && localidadSelected !== "") {
      ...
      setResultados(result.filter((valor) => valor.entidad.match(value)));
    }
  };
  const onLocalidad = (value) => {
    if (value === null) {
      ...
      if (entidadSelected !== "" && ratingSelected !== "") {
        ...
        setResultados(
          copyResult.filter((valor) => valor.entidad.match(entidadSelected))
        );
      } else if (entidadSelected === "" && ratingSelected !== "") {
        setResultados(
  ...
  const onRating = (value) => {
    ...
    if (localidadSelected !== "" && entidadSelected !== "") {
      ...
      setResultados(
        copyResult.filter((valor) => value.match(valor.valoracionPromedio))
      );
    }
  };
  const entidades = () => {
    ...
    if (disableSearch === true) {
      ...
      return (
        <div class="col-md-2 mb-2 my-auto">
          ...
          <label className={classes.labels} for="localidad">
          ...
          <Autocomplete
            ...
            renderInput={(params) => (
              <TextField
                style={{ width: "13.8rem", backgroundColor: "white" }}
                {...params}
  ...
  const ratings = () => {
    if (disableSearch === true) {
      ...
      return (
        <div class="col-md-2 mb-2 my-auto">
          <label className={classes.labels} for="rating">
            Valoración
          </label>
          <br />
          <select
  ...
  const onSearch = (value) => {
    ...
    } else if (entidadSelected === "Profesional") {
      setResultados(
        copyResult.filter((valor) =>
          valor.especialidad
            .toLowerCase()
    ...
    } else if (entidadSelected === "Institucion") {
      setResultados(
        copyResult.filter((valor) =>
          valor.especialidad
            .toLowerCase()
      ...
      return (
        <div class="col-md-3 mb-2 my-auto">
          {entidadSelected === "Profesional" ? (
            <div>
              <label className={classes.labels} for="search">
          ...
          {entidadSelected === "Institucion" ? (
            <div>
              <label className={classes.labels} for="search">
                Buscar institución por especialidad
              </label>
              <br />
              <input
                id="search"
  ...
  const seeMoreInfo = (value) => {
    history.push({
      pathname: `/Cartilla/${value.entidad}/${value.id}`,
      state: value,
    });
  };
  const listEntidades = () => {
  ...
  return (
    <div className={classes.Cartilla}>
      ...
      <div class="col-11 p-4">{listEntidades()}</div>
    </div>
  );
}
